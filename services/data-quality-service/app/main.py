...
from app.interfaces.api.catalog_change_approval_router import (
    router as catalog_change_approval_router,
)
...
from app.interfaces.api.indicator_approval_router import router as indicator_approval_router
