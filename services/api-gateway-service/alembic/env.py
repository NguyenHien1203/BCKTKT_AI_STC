...
# TẤT CẢ service. Nếu không đặt tên riêng, service khác có thể đọc nhầm
# revision đã stamp bởi service này (và ngược lại) -> lỗi "Can't locate
# revision identified by '...'". Mỗi service phải có version_table riêng.
VERSION_TABLE = "alembic_version_api_gateway"
