...
# TẤT CẢ service. Nếu không đặt tên riêng, ingestion-service sẽ đọc nhầm
# revision đã stamp bởi auth-identity-service (và ngược lại) -> lỗi
# "Can't locate revision identified by '...'". Mỗi service phải có
# version_table riêng.
